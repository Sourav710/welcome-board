...
export const templates: ChecklistTemplate[] = [
  ...
  // Training
  { id: 't29', role: 'Developer', section: 'Training', title: 'Security Compliance Training', description: 'Complete mandatory security compliance certification', type: 'training', mandatory: true, defaultOwner: 'Employee', defaultLinkUrl: 'https://uhg.edcast.com/home', targetDay: 5 },
